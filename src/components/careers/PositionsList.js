...
function PositionsList() {
    return(
        <div className="max-w-full mx-12 bg-white">
            <h2 className="text-5xl font-bold text-gray-900 pb-8">Posiciones Abiertas</h2>
            <p className="text-2xl font-regular text-gray-600 mx-w-3xl leading-10">Carreras disponibles en nuestra plataforma. Inscribite ahora. </p>
