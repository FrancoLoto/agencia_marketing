...
const navigation = {
    ...
    social: [
      {
        name: 'Facebook',
        href: 'https://www.facebook.com/profile.php?id=100085382960004',
        icon: (props) => (
      ...
      {
        name: 'Instagram',
        href: 'https://www.instagram.com/mgseguridadprivada/',
        icon: (props) => (
          <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
            <path
              fillRule="evenodd"
    ...
    return(
        ...
        <div className="mx-auto lg:mx-12 max-w-full py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
          <div className="xl:grid xl:grid-cols-3 xl:gap-8">
            ...
            <div className="mt-12 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
              <div className="md:grid md:grid-cols-2 md:gap-8">
                <div>
                  <h3 className="text-base font-medium text-gray-400">Visitanos</h3>
                  <ul  className="mt-4 space-y-4">
                    
                      <li className="text-base text-gray-50">
                      Ruta Nacional 251<br/>
                      Km 117,5<br/>
          ...
          <div className="mt-12 border-t border-gray-200 pt-8">
            <p className="text-base text-gray-200 xl:text-center">&copy; 2023 MG Seguridad Privada. Todos los derechos reservados.</p>
          </div>
        </div>
      </footer>
    )
