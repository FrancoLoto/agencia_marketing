    ...
    return(
        <Layout>
            ...
            <>
            {
                    ...
                    <div className="relative mx-auto max-w-7xl py-24 px-4 sm:py-32 sm:px-6 lg:px-8">
                        ...
                        <div className="min-w-0 flex-1 p-4 pt-8">
                            <div className="">
                                ...
                                <span className=" hover:text-celeste  mx-1 font-medium text-gray-800 text-sm "><Link to={`/category/${post.category.slug}`}>{post.category.name}</Link></span> <span className="text-gray-300">&middot;</span> 
                                ...
                                <span className="mt-2 mx-2 font-medium text-gray-800 text-sm">{post.time_read} min de lectura.</span> 
                ...
                <div>No se encontro el detalle</div>
            )}
            </>
            )}
            <Footer/>
