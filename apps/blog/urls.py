...
from .views import (AuthorBlogListView, BlogListView, CreateBlogPostView,
                    DeleteBlogPostView, DraftBlogPostView, EditBlogPostView,
                    ListPostByCategoryView, PostDetailView,
                    PublishBlogPostView)
